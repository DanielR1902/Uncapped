...
```json
{
  ...
  "action":
    ...
    {"type": "save_build", "name": "<string>", "destination": "draft" | "build",
      "publish_immediately": "<bool>", "author_notes": "<string>" | null, "explanation": "<string>"} |
